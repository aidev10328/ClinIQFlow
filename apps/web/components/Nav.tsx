...
export default function Nav() {
  ...
  const hideNav = pathname === '/login' || pathname.startsWith('/hospital') || pathname.startsWith('/admin') || pathname.startsWith('/doctor') || pathname.startsWith('/queue/status') || pathname.startsWith('/appointments/status') || pathname.startsWith('/reset-password');
