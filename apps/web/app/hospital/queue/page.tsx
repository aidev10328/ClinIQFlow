...
export default function QueuePage() {
  ...
  const { getCurrentTime, formatDate, formatTime: formatTimeHospital } = useHospitalTimezone();
      ...
      <div className="flex-1 flex gap-2 p-2 min-h-0 overflow-hidden">
        ...
        <div className="w-[520px] flex flex-col gap-1.5 flex-shrink-0 min-h-0">
          ...
          <div className="h-[90px] bg-navy-50 rounded border border-navy-200 shadow-sm flex flex-col">
            <div className="flex-shrink-0 px-2 py-1 border-b border-navy-200 flex items-center justify-between">
